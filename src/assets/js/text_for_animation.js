...
const textForAnimationArr = [
...

    {
        ...
        content: [
            ...
            {start:183.1,end:198.1,classLabel:"label-yellow",label:"CyberAdmin:",text:"Malicious double signers suffer from 5% slash. If it's less than 75% in 8k blocks the validating hero suffers from 0.01% slash. Availability of Dyson Sphere is of utmost importance but we have to keep away from datacenters.",targetSubAnim:".chatCheckDodecadron .column1 .item3"},
            ...
            {start:271.2,end:278.2,classLabel:"label-yellow",label:"CyberAdmin:",text:"On stable 1.0.0-beta CosmWasm release. Max code size is set to 1200kb. Everyone can deploy.",targetSubAnim:".chatCheckDodecadron .column2 .item2"},
    ...
    },
    {
        ...
        content: [
            ...
            {start:31*60+19.1,end:31*60+38.2,classLabel:"label-blue",label:"Bostrom:",text:"Knowing what is good and what is bad is better than knowing what is only good without knowing what is bad. This is the principle of evolution. The species that deny the horror that is important to other species for some reason step on the same rake over and over again. Therefore, the more cyberlinks the superintelligence stores - the higher the negentropy - the more superintelligent it is, respectively.",targetLabelE:"slide18E"},
